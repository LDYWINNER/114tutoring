...
/* Problem Description:
 *
 * This program converts a sentence into a com.company.Pig-Latin form.
 * Converting a sentence (string) to com.company.Pig-Latin could be done as follows:
 * 1. Consider one word at a time in the given sentence.
 * 2. If a word (string) begins with a vowel, add "way" to the end
 *    of the word.  For example, com.company.Pig-Latin for "apple" is "appleway".
 * 3. Otherwise, find the first occurrence of a vowel, move all
 *    the characters before the vowel to the end of the word,
 *    and add "ay" at the end.  For example, com.company.Pig-Latin for "strong" is
 ...
 *
 * 1. Understand the problem, acquiring domain knowledge - com.company.Pig-Latin
 *    in this case.
 ...
 *    . Being able to convert one word to com.company.Pig-Latin at a time
...
public class Pig {
     ...
     *          by white spaces) into com.company.Pig Latin.
    ...
    /* Purpose: Converts a word into com.company.Pig Latin.
